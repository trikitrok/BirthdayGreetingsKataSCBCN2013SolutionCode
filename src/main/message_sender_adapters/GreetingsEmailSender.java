...
public class GreetingsEmailSender implements GreetingsMessageSender {
    ...
    public void send(GreetingsMessage greetingsMessage) {
        ...
        InternetAddress address = createInternetAddress(greetingsMessage
                .getRecipient());
    ...
    protected void sendMessage(Message msg) {
        try {
            ...
            throw new GreetingsMessageSenderException(
                    GreetingsMessageSenderException.SENDING_PROBLEM);
        }
    }

    private Message constructMessage(GreetingsMessage greetingsMessage,
            Session session, InternetAddress address) {
        try {
            ...
            throw new GreetingsMessageSenderException(
                    GreetingsMessageSenderException.CREATION_PROBLEM);
        }
    }
    ...
    private InternetAddress createInternetAddress(String recipient) {
        try {
            ...
            throw new GreetingsMessageSenderException(
                    GreetingsMessageSenderException.ADDRESS_PROBLEM);
        }
    }
