...
public class AcceptanceTest {
	...
	public void setUp() throws Exception {
		...
		greetingsMessageSender = new GreetingsEmailSender(SMTP_HOST, SMTP_PORT, SENDER) {			
			@Override
		...
		employeeRepository = new FileEmployeeRepository("src/test/resources/employee_data.txt");
